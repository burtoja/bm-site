...
if (!function_exists('get_db_connection')) {
    include $_SERVER["DOCUMENT_ROOT"] . '/product_search_scripts/backend/db_connection.php';
}

function boilersa_search_block_shortcode($atts) {
...
//// Left Column – FILTERS ////
    ...
    echo file_get_contents($_SERVER["DOCUMENT_ROOT"] . '/product_search_scripts/frontend/filter_tree_component.html');
...
//// Right Column – RESULTS ////
    ...
    echo '<script src="/product_search_scripts/frontend/build_query_from_selections.js?v=' . $ver . '"></script>';
    echo '<script src="/product_search_scripts/frontend/filter_tree_controller.js?v=' . $ver . '"></script>';
...
add_shortcode('boilersa_search_block', 'boilersa_search_block_shortcode');
