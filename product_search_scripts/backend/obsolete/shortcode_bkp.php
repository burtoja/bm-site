...
//// Right Column – RESULTS ////
    ...
    echo '<script src="/product_search_scripts/frontend/select_category.js?v=' . $ver . '"></script>';
    ...
    echo '<script src="/product_search_scripts/frontend/load_subcategory_filters.js?v=' . $ver . '"></script>';
