...
function waitForFormAndAttachListener(retries = 20) {
    ...
    if (form) {
        form.addEventListener("submit", async function (e) {
            ...
            try {
                const translatedFilters = await fetch('/product_search_scripts/backend/translate_filters.php', {
                    method: 'POST',
                ...
                const apiUrl = '/product_search_scripts/backend/search_ebay.php?' + normalizedParams.toString();
